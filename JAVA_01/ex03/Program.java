class	Program {
	static public void	main(String args[]) {
		...
		// I know that we cannot use try catch for this excercise (as well as comments in the program)
		// but it is necessary to show you that the program works correctly
